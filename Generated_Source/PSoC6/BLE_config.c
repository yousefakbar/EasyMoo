...
cy_stc_ble_gapp_disc_data_t cy_ble_discoveryData[0x02u] = {
    ...
    /* Peripheral configuration 0 */
    {
        { 0x02u, 0x01u, 0x06u, 0x07u, 0x09u, 0x59u, 0x6Fu,
        0x75u, 0x73u, 0x65u, 0x66u, 0x11u, 0x21u, 0xF0u,
        0x48u, 0x43u, 0xE0u, 0x67u, 0x5Au, 0x06u, 0xBBu,
        0xA8u, 0x44u, 0x72u, 0x04u, 0xECu, 0xA7u, 0x56u,
...
static uint8_t cy_ble_attValues[0x18u] = {
    /* Device Name */
    (uint8_t)'Y', (uint8_t)'o', (uint8_t)'u', (uint8_t)'s', (uint8_t)'e', (uint8_t)'f', 
...
static const uint8_t cy_ble_attUuid128[][16u] = {
    /* Device Interface */
    { 0xF0u, 0x48u, 0x43u, 0xE0u, 0x67u, 0x5Au, 0x06u, 0xBBu, 0xA8u, 0x44u, 0x72u, 0x04u, 0xECu, 0xA7u, 0x56u, 0x84u },
    /* Device Inbound */
    { 0x6Eu, 0x2Au, 0x4Eu, 0x5Eu, 0xC4u, 0x4Bu, 0x66u, 0x84u, 0xB4u, 0x4Cu, 0xE7u, 0xACu, 0x75u, 0x52u, 0x65u, 0xB0u },
    /* Device Outbound */
    { 0x54u, 0xA0u, 0x6Fu, 0xF4u, 0x50u, 0x16u, 0x59u, 0x90u, 0x05u, 0x49u, 0x94u, 0x93u, 0x2Au, 0xC4u, 0x47u, 0x54u },
};
...
static cy_stc_ble_gatts_att_gen_val_len_t cy_ble_attValuesLen[0x0Cu] = {
    ...
    { 0x0001u, (void *)&cy_ble_attValues[22] }, /* Device Inbound */
    { 0x0010u, (void *)&cy_ble_attUuid128[2] }, /* Device Outbound UUID */
    { 0x0001u, (void *)&cy_ble_attValues[23] }, /* Device Outbound */
};
...
static const cy_stc_ble_gatts_db_t cy_ble_gattDB[0x14u] = {
    ...
    { 0x0012u, 0x5275u /* Device Inbound                      */, 0x09080100u /* wr    */, 0x0012u, {{0x0001u, (void *)&cy_ble_attValuesLen[9]}} },
    { 0x0013u, 0x2803u /* Characteristic                      */, 0x00020001u /* rd    */, 0x0014u, {{0x0010u, (void *)&cy_ble_attValuesLen[10]}} },
    { 0x0014u, 0xC42Au /* Device Outbound                     */, 0x09020001u /* rd    */, 0x0014u, {{0x0001u, (void *)&cy_ble_attValuesLen[11]}} },
};
