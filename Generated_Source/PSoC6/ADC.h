...
void ADC_Init(void);
__STATIC_INLINE void ADC_Enable(void);
...
__STATIC_INLINE void ADC_StopConvert(void);
...
__STATIC_INLINE int16_t ADC_GetResult16(uint32_t chan);
__STATIC_INLINE int32_t ADC_GetResult32(uint32_t chan);
__STATIC_INLINE void ADC_SetLowLimit(uint32_t lowLimit);
__STATIC_INLINE void ADC_SetHighLimit(uint32_t highLimit);
__STATIC_INLINE void ADC_SetLimitMask(uint32_t limitMask);
__STATIC_INLINE void ADC_SetSatMask(uint32_t satMask);
__STATIC_INLINE cy_en_sar_status_t ADC_SetOffset(uint32_t chan, int16_t offset);
__STATIC_INLINE cy_en_sar_status_t ADC_SetGain(uint32_t chan, int32_t adcGain);
__STATIC_INLINE float32_t ADC_CountsTo_Volts(uint32_t chan, int16_t adcCounts);
__STATIC_INLINE int16_t ADC_CountsTo_mVolts(uint32_t chan, int16_t adcCounts);
__STATIC_INLINE int32_t ADC_CountsTo_uVolts(uint32_t chan, int16_t adcCounts);
...
* @{
*/
__STATIC_INLINE void ADC_Sleep(void);
__STATIC_INLINE void ADC_Wakeup(void);
...
#define ADC_CFG0_VREF_PWR                (2uL)
#define ADC_CFG0_COMP_PWR                (3uL)
#define ADC_CFG0_COMP_DLY                (3uL)

/* Clock parameters*/
#if (ADC_CLOCK_INTERNAL)
    #define ADC_CFG0_CLOCKDIVIDER        (((CYDEV_CLK_PERICLK__HZ) / (ADC_CFG0_NOMINAL_CLOCK_FREQ)) - 1u)
#endif /* (ADC_CLOCK_INTERNAL) */
...
/* ************************************************************************** */
    ...
    #define ADC_CFG1_VREF_PWR                (uL)
    #define ADC_CFG1_COMP_PWR                (uL)
    #define ADC_CFG1_COMP_DLY                (uL)

    /* Clock parameters*/
    #if (ADC_CLOCK_INTERNAL)
        #define ADC_CFG1_CLOCKDIVIDER        (((CYDEV_CLK_PERICLK__HZ) / (ADC_CFG1_NOMINAL_CLOCK_FREQ)) - 1u)
    #endif /* (ADC_CLOCK_INTERNAL) */
...
/* ************************************************************************** */
    ...
    #define ADC_CFG2_VREF_PWR                (uL)
    #define ADC_CFG2_COMP_PWR                (uL)
    #define ADC_CFG2_COMP_DLY                (uL)

    /* Clock parameters*/
    #if (ADC_CLOCK_INTERNAL)
        #define ADC_CFG2_CLOCKDIVIDER        (((CYDEV_CLK_PERICLK__HZ) / (ADC_CFG2_NOMINAL_CLOCK_FREQ)) - 1u)
    #endif /* (ADC_CLOCK_INTERNAL) */
...
/* ************************************************************************** */
    ...
    #define ADC_CFG3_VREF_PWR                (uL)
    #define ADC_CFG3_COMP_PWR                (uL)
    #define ADC_CFG3_COMP_DLY                (uL)

    /* Clock parameters*/
    #if (ADC_CLOCK_INTERNAL)
        #define ADC_CFG3_CLOCKDIVIDER        (((CYDEV_CLK_PERICLK__HZ) / (ADC_CFG3_NOMINAL_CLOCK_FREQ)) - 1u)
    #endif /* (ADC_CLOCK_INTERNAL) */
...
* functions.
*/
extern uint8_t ADC_initVar;
extern uint8_t ADC_selected;
extern uint32_t ADC_currentConfig;
...
*/
extern cy_stc_syspm_callback_t ADC_DeepSleepCallbackStruct;
...
/* Set soc operation to edge or level based on sample mode */
    ...
    #define ADC_CFG0_DSI_TRIGGER_LEVEL_INIT    (SAR_SAMPLE_CTRL_DSI_TRIGGER_LEVEL_Msk)
#else /* Edge trigger */
...
/* Set SE_NEG_INPUT */
    ...
    #define ADC_CFG0_NEG_OTHER                 (uint16)((uint16)ADC_SARMUX__VNEG0 << SAR_CTRL_NEG_SEL_Pos)
    #define ADC_CFG0_SWITCH_CONF_INIT          0u
#else /* Disable SAR sequencer from enabling routing switches in single channel mode */
    #define ADC_CFG0_SWITCH_CONF_INIT          SAR_CTRL_SWITCH_DISABLE_Msk
...
#else
    #define ADC_CFG0_HW_CTRL_NEGVREF_INIT      SAR_CTRL_SAR_HW_CTRL_NEGVREF_Msk
#endif /* ADC_CFG0_CHANNEL_COUNT == 1u */
...
#define ADC_CFG0_RANGE_COND_INIT   (cy_en_sar_range_detect_condition_t)ADC_CFG0_RANGE_COND
...
/* ************************************************************************** */
    ...
    /* Set soc operation to edge or level based on sample mode */
        ...
        #define ADC_CFG1_DSI_TRIGGER_LEVEL_INIT    (SAR_SAMPLE_CTRL_DSI_TRIGGER_LEVEL_Msk)
    #else /* Edge trigger */
    ...
    #define ADC_CFG1_NEG_OTHER                 (uint16)((uint16)ADC_SARMUX__VNEG1 << SAR_CTRL_NEG_SEL_Pos)
    #define ADC_CFG1_SWITCH_CONF_INIT          0u

    /* If the SAR is configured for multiple channels, always set SAR_HW_CTRL_NEGVREF to 1 */
    #define ADC_CFG1_HW_CTRL_NEGVREF_INIT      SAR_CTRL_SAR_HW_CTRL_NEGVREF_Msk
    ...
    #define ADC_CFG1_VREF_POWER_INIT  \
            (ADC_CFG1_VREF_PWR \
            << SAR_CTRL_PWR_CTRL_VREF_Pos)

    #define ADC_CFG1_COMP_PWR_INIT  \
            (ADC_CFG1_COMP_PWR \
            << SAR_CTRL_COMP_PWR_Pos)

    #define ADC_CFG1_COMP_DLY_INIT  \
            (ADC_CFG1_COMP_DLY \
            << SAR_CTRL_COMP_DLY_Pos)

    #define ADC_CFG1_CTRL_INIT  \
            (ADC_CFG1_VREF_POWER_INIT \
            | ADC_CFG1_VREF_SEL_MASK \
            | ADC_CFG1_SE_NEG_INPUT_INIT \
            | ADC_CFG1_HW_CTRL_NEGVREF_INIT \
            | ADC_CFG1_COMP_DLY_INIT \
            | SAR_CTRL_REFBUF_EN_Msk \
            | ADC_CFG1_COMP_PWR_INIT \
            | SAR_CTRL_DSI_SYNC_CONFIG_Msk  \
    ...
    #define ADC_CFG1_RANGE_COND_INIT   (cy_en_sar_range_detect_condition_t)ADC_CFG1_RANGE_COND
...
/* ************************************************************************** */
    ...
    /* Set soc operation to edge or level based on sample mode */
        ...
        #define ADC_CFG2_DSI_TRIGGER_LEVEL_INIT    (SAR_SAMPLE_CTRL_DSI_TRIGGER_LEVEL_Msk)
    #else /* Edge trigger */
   ...
   #define ADC_CFG2_NEG_OTHER                 (uint16)((uint16)ADC_SARMUX__VNEG2 << SAR_CTRL_NEG_SEL_Pos)

    #define ADC_CFG2_SWITCH_CONF_INIT          0u

    /* If the SAR is configured for multiple channels, always set SAR_HW_CTRL_NEGVREF to 1 */
    #define ADC_CFG2_HW_CTRL_NEGVREF_INIT      SAR_CTRL_SAR_HW_CTRL_NEGVREF_Msk
    ...
    #define ADC_CFG2_VREF_POWER_INIT  \
            (ADC_CFG2_VREF_PWR \
            << SAR_CTRL_PWR_CTRL_VREF_Pos)

    #define ADC_CFG2_COMP_PWR_INIT  \
            (ADC_CFG2_COMP_PWR \
            << SAR_CTRL_COMP_PWR_Pos)

    #define ADC_CFG2_COMP_DLY_INIT  \
            (ADC_CFG2_COMP_DLY \
            << SAR_CTRL_COMP_DLY_Pos)

    #define ADC_CFG2_CTRL_INIT  \
            (ADC_CFG2_VREF_POWER_INIT \
            | ADC_CFG2_VREF_SEL_MASK \
            | ADC_CFG2_SE_NEG_INPUT_INIT \
            | ADC_CFG2_HW_CTRL_NEGVREF_INIT \
            | ADC_CFG2_COMP_DLY_INIT \
            | SAR_CTRL_REFBUF_EN_Msk \
            | ADC_CFG2_COMP_PWR_INIT \
            | SAR_CTRL_DSI_SYNC_CONFIG_Msk  \
    ...
    #define ADC_CFG2_RANGE_COND_INIT   (cy_en_sar_range_detect_condition_t)ADC_CFG2_RANGE_COND
...
/* ************************************************************************** */
    ...
    /* Set soc operation to edge or level based on sample mode */
        ...
        #define ADC_CFG3_DSI_TRIGGER_LEVEL_INIT    (SAR_SAMPLE_CTRL_DSI_TRIGGER_LEVEL_Msk)
    #else /* Edge trigger */
    ...
    #define ADC_CFG3_NEG_OTHER                 (uint16)((uint16)ADC_SARMUX__VNEG3 << SAR_CTRL_NEG_SEL_Pos)

    #define ADC_CFG3_SWITCH_CONF_INIT          0u

    /* If the SAR is configured for multiple channels, always set SAR_HW_CTRL_NEGVREF to 1 */
    #define ADC_CFG3_HW_CTRL_NEGVREF_INIT      SAR_CTRL_SAR_HW_CTRL_NEGVREF_Msk
    ...
    #define ADC_CFG3_VREF_POWER_INIT  \
            (ADC_CFG3_VREF_PWR \
            << SAR_CTRL_PWR_CTRL_VREF_Pos)

    #define ADC_CFG3_COMP_PWR_INIT  \
            (ADC_CFG3_COMP_PWR \
            << SAR_CTRL_COMP_PWR_Pos)

    #define ADC_CFG3_COMP_DLY_INIT  \
            (ADC_CFG3_COMP_DLY \
            << SAR_CTRL_COMP_DLY_Pos)

    #define ADC_CFG3_CTRL_INIT  \
            (ADC_CFG3_VREF_POWER_INIT \
            | ADC_CFG3_VREF_SEL_MASK \
            | ADC_CFG3_SE_NEG_INPUT_INIT \
            | ADC_CFG3_HW_CTRL_NEGVREF_INIT \
            | ADC_CFG3_COMP_DLY_INIT \
            | SAR_CTRL_REFBUF_EN_Msk \
            | ADC_CFG3_COMP_PWR_INIT \
            | SAR_CTRL_DSI_SYNC_CONFIG_Msk  \
    ...
    #define ADC_CFG3_RANGE_COND_INIT   (cy_en_sar_range_detect_condition_t)ADC_CFG3_RANGE_COND
...
__STATIC_INLINE void ADC_StopConvert(void)
{
    Cy_SAR_StopConvert(ADC_SAR__HW);
}
...
__STATIC_INLINE int16_t ADC_GetResult16(uint32_t chan)
{
    ...
    CY_ASSERT(chan < ADC_allConfigs[ADC_currentConfig].numChannels);

    return Cy_SAR_GetResult16(ADC_SAR__HW, chan);
}
...
__STATIC_INLINE int32_t ADC_GetResult32(uint32_t chan)
{
    ...
    finalResult = Cy_SAR_GetResult32(ADC_SAR__HW, chan);
...
__STATIC_INLINE void ADC_SetLowLimit(uint32_t lowLimit)
{
    Cy_SAR_SetLowLimit(ADC_SAR__HW, lowLimit);
}
...
__STATIC_INLINE void ADC_SetHighLimit(uint32_t highLimit)
{
    Cy_SAR_SetHighLimit(ADC_SAR__HW, highLimit);
}
...
__STATIC_INLINE void ADC_SetLimitMask(uint32_t limitMask)
{
    Cy_SAR_SetRangeInterruptMask(ADC_SAR__HW, limitMask);
}
...
__STATIC_INLINE void ADC_SetSatMask(uint32_t satMask)
{
    Cy_SAR_SetSatInterruptMask(ADC_SAR__HW, satMask);
}
...
__STATIC_INLINE float32_t ADC_CountsTo_Volts(uint32_t chan, int16_t adcCounts)
{
    ...
    return Cy_SAR_CountsTo_Volts(ADC_SAR__HW, chan, adcCounts);
}
...
__STATIC_INLINE int16_t ADC_CountsTo_mVolts(uint32_t chan, int16_t adcCounts)
{
    ...
    return Cy_SAR_CountsTo_mVolts(ADC_SAR__HW, chan, adcCounts);
}
...
__STATIC_INLINE int32_t ADC_CountsTo_uVolts(uint32_t chan, int16_t adcCounts)
{
    ...
    return Cy_SAR_CountsTo_uVolts(ADC_SAR__HW, chan, adcCounts);
}
...
* calls the ADC_Stop() function.
*
* Calling this routine directly is not needed.
* The ADC_DeepSleepCallbackStruct will ensure this routine
...
* ADC_Sleep() was called.
* If the component was enabled before the ADC_Sleep()
