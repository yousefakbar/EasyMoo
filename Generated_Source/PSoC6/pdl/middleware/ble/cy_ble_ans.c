...
static cy_ble_gatt_db_attr_handle_t cy_ble_anscReqHandle[CY_BLE_GATTC_COUNT];
...
*    for Alert Notification Service is:<br>
...
static void Cy_BLE_ANSC_NotificationEventHandler(cy_stc_ble_gattc_handle_value_ntf_param_t *eventParam)
{
    ...
    if((discIdx < CY_BLE_GATTC_COUNT) && (Cy_BLE_ANS_ApplCallback != NULL))
    {
