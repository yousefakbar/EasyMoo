...
***************************************/
#ifdef CY_BLE_HIDS_CLIENT
extern cy_stc_ble_hidsc_t cy_ble_hidsc[CY_BLE_GATTC_COUNT][CY_BLE_HIDSC_SERVICE_COUNT];
extern uint8_t cy_ble_hidscServiceCount[CY_BLE_GATTC_COUNT];
extern uint8_t cy_ble_hidscDisServiceIndex[CY_BLE_GATTC_COUNT];
#endif /* CY_BLE_HIDS_CLIENT */
