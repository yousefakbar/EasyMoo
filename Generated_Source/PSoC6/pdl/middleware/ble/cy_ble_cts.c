...
static cy_ble_gatt_db_attr_handle_t cy_ble_ctscReqHandle[CY_BLE_GATTC_COUNT];
...
***************************************************************************//**
*
*  Registers a callback function for Current Time Service specific attribute 
*  operations.
...
*    for Current Time Service is:<br>
...
static void Cy_BLE_CTSC_NotificationEventHandler(cy_stc_ble_gattc_handle_value_ntf_param_t *eventParam)
{
    ...
    if((discIdx < CY_BLE_GATTC_COUNT) && (Cy_BLE_CTS_ApplCallback != NULL))
    {
                                                               ...
                                                               uint8_t descrIndex)
{
    ...
    else if((discIdx < CY_BLE_GATTC_COUNT) && (charIndex == CY_BLE_CTS_CURRENT_TIME) &&
