...
***************************************************************************//**
*
*  This function is used by GAP Peripheral application to configure the device into one of the GAP Discoverable modes 
*  and start the advertisement procedure. This is a non-blocking function.
*
*  CY_BLE_EVT_GAPP_ADVERTISEMENT_START_STOP event is received when advertisement is sucessfully started.
*
...
*
*  CY_BLE_EVT_TIMEOUT - If device is not commected to any peer device within the specified timeout limit(param->advTo). 
*
...
***************************************************************************//**
*
*  This function is used by GAP Peripheral application to stop the advertisement.
...
***************************************************************************//**
*
*  This function is used by GAP Peripheral application to set Advertisement and/or 
...
***************************************************************************//**
*
*  This function is used by GAP Peripheral application to send Pairing Response in  
...
*        procedure, SMP keys will not be distributed even if application has generated 
