...
#ifdef CY_BLE_ESS_CLIENT
extern uint8_t activeCharIndex[CY_BLE_GATTC_COUNT];
extern uint8_t activeCharInstance[CY_BLE_GATTC_COUNT];
extern uint8_t prevCharInstIndex[CY_BLE_GATTC_COUNT];
#endif /* (CY_BLE_ESS_CLIENT) */
