...
#define CY_BLE_MIDDLEWARE_VERSION_MINOR      (30)
...
#define CY_BLE_ALIGN_TO_4(x)                        ((((x) & 3u) == 0u) ? (x) : (((x) - ((x) & 3u)) + 4u))
    ...
    /* If mtu > 23 stack queue depth = stack queue depth = (stack queue depth per connection - 1) * maxBleConnection */
    #define CY_BLE_GATT_MTU_BUFF_COUNT              ((CY_BLE_GATT_MTU > CY_BLE_MTU_MIN_VALUE ? \
