...
#ifdef CY_BLE_AIOS_CLIENT
extern uint8_t cy_ble_aioscActiveCharIndex[CY_BLE_GATTC_COUNT];
extern uint8_t cy_ble_aioscActiveCharInstance[CY_BLE_GATTC_COUNT];
extern uint8_t cy_ble_aioscPrevCharInstIndex[CY_BLE_GATTC_COUNT];
#endif /* (CY_BLE_AIOS_CLIENT) */
