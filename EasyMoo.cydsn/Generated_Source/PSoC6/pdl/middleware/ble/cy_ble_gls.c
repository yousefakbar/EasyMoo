...
static cy_ble_gatt_db_attr_handle_t cy_ble_glscReqHandle[CY_BLE_GATTC_COUNT];
...
***************************************************************************//**
*
*  This function initializes the Glucose Service.
*  Initializes the profile internals.
*
*  \param config: Configuration structure for the Glucose Service.
*
*  \return
...
***************************************************************************//**
*
*  Registers a callback function for Glucose Service specific attribute operations.
                                                          ...
                                                          uint8_t * attrValue)
{
    ...
    else if((charIndex >= CY_BLE_GLS_CHAR_COUNT) || (discIdx >= CY_BLE_GATTC_COUNT))
    {
        apiResult = CY_BLE_ERROR_INVALID_PARAMETER;
    }
...
static void Cy_BLE_GLSC_NotificationEventHandler(cy_stc_ble_gattc_handle_value_ntf_param_t *eventParam)
{
    ...
    if((discIdx < CY_BLE_GATTC_COUNT) && (Cy_BLE_GLS_ApplCallback != NULL))
    {
        cy_stc_ble_gls_char_value_t locCharValue = { .connHandle = eventParam->connHandle };
