...
static cy_ble_gatt_db_attr_handle_t cy_ble_bmscReqHandle[CY_BLE_GATTC_COUNT];
                                                          ...
                                                          cy_en_ble_bms_char_index_t charIndex)
{
    ...
    else if((charIndex != CY_BLE_BMS_BMFT) || (discIdx >= CY_BLE_GATTC_COUNT))
    {
        apiResult = CY_BLE_ERROR_INVALID_PARAMETER;
    }
                                                          ...
                                                          uint8_t * attrValue)
{
    ...
    else if((charIndex != CY_BLE_BMS_BMCP) || (discIdx >= CY_BLE_GATTC_COUNT))
    {
        apiResult = CY_BLE_ERROR_INVALID_PARAMETER;
    }
...
static void Cy_BLE_BMSC_ReadResponseEventHandler(cy_stc_ble_gattc_read_rsp_param_t *eventParam)
{
    ...
    if((discIdx < CY_BLE_GATTC_COUNT) && (Cy_BLE_BMS_ApplCallback != NULL) &&
