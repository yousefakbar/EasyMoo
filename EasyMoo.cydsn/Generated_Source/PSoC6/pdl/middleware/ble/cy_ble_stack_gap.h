...
*  Note2: To guarantees that this function generate different addresses everytime,
...
*               Note: The application shall preferrably use 
...
*
*               parma->bdHandle: bd Handle of the remote device to be disconnected
*
* \return
*  cy_en_ble_api_result_t : Return value indicates whether the function succeeded or
*  failed. Following are the possible error codes.
...
*  Note2: Cy_BLE_GenerateRandomNumber() should be called everytime with unique seeds before calling this function to guarantee different keys,
*
******************************************************************************/
