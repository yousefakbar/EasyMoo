...
typedef struct
{
    ...
    cy_ble_gatt_db_attr_handle_t customServCharHandle[CY_BLE_GATTC_COUNT];

    /** Characteristic end handle */
    cy_ble_gatt_db_attr_handle_t customServCharEndHandle[CY_BLE_GATTC_COUNT];
    ...
    uint8_t                      properties[CY_BLE_GATTC_COUNT];
...
typedef struct
{
    ...
    cy_ble_gatt_db_attr_handle_t customServHandle[CY_BLE_GATTC_COUNT];
