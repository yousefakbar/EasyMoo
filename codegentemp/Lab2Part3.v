// ======================================================================
// Lab2Part3.v generated from TopDesign.cysch
// 02/25/2020 at 11:48
...
module SCB_UART_PDL_v2_0_0 (
	...
	cy_clock_v1_0
		#(.id("12fcfe22-2bfc-4dde-99bd-1d9a44b6194e/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("12fcfe22-2bfc-4dde-99bd-1d9a44b6194e/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("12fcfe22-2bfc-4dde-99bd-1d9a44b6194e/b7e8018e-1ef7-49c0-b5a5-61641a03e31c"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("0"),
		  .ibuf_enabled("1"),
...
module SCB_UART_PDL_v2_0_1 (
	...
	cy_clock_v1_0
		#(.id("78d19613-3625-4ad5-9ac8-4cd70befd8ee/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("723379629.62963"),
		  .is_direct(0),
	...
	cy_mxs40_gpio_v1_0
		#(.id("78d19613-3625-4ad5-9ac8-4cd70befd8ee/65f3af6c-759b-4ccb-8c66-5c95ba1f5f4f"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("6"),
		  .ibuf_enabled("0"),
...
// MCWDT_PDL_v1_10(C0_enable=true, C0ClearOnMatch=0, C0Match=32768, C0Mode=0, C1_enable=true, C1ClearOnMatch=0, C1Match=32768, C1Mode=0, C2_enable=true, C2Mode=0, C2Period=16, CascadeC0C1=true, CascadeC1C2=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=MCWDT_PDL_v1_10, CY_CONFIG_TITLE=MCWDT_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=MCWDT_0, CY_INSTANCE_SHORT_NAME=MCWDT_0, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=mcwdt, CY_PDL_DRIVER_REQ_VERSION=1.0, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=MCWDT_0, )
module MCWDT_PDL_v1_10_2 (
    interrupt);
    output      interrupt;
...
module Scan_ADC_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("7a065b09-76c2-4ec2-80fd-af3db47ec55a/f7143d07-534d-4542-813a-8bb23ceb1ae9"),
...
module SCB_I2C_PDL_v2_0_4 (
	...
	cy_clock_v1_0
		#(.id("e0f9a033-16ab-4478-8b66-038a856b13f6/b68e5b9d-7828-482d-a282-930f990e3b3e"),
		  .source_clock_id(""),
		  .divisor(0),
...
// bIncludeDriverToComponent_v1_0(PDL_DRIVER_NAME=ble, PDL_DRIVER_REQ_VERSION=2.0.0, PDL_DRIVER_SUBGROUP=Stack library, PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=bIncludeDriverToComponent_v1_0, CY_CONFIG_TITLE=IncludeBleLibs, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=BLE:IncludeBleLibs, CY_INSTANCE_SHORT_NAME=IncludeBleLibs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=ble, CY_PDL_DRIVER_REQ_VERSION=2.0.0, CY_PDL_DRIVER_SUBGROUP=Stack library, CY_PDL_DRIVER_VARIANT=Profile - Host CM4 / Ctrl CM4, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=BLE_IncludeBleLibs, )
module bIncludeDriverToComponent_v1_0_5 ;
...
module BLE_PDL_v2_0_6 (
    ...
    bIncludeDriverToComponent_v1_0_5 IncludeBleLibs ();
...
module top ;
	...
	cy_mxs40_gpio_v1_0
		#(.id("bc41a1d3-44f9-4a39-ac8b-fa3ec4d2a03a"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("1"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("3b7ad9d0-90f3-4aa4-aa27-a620d8675357"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("0"),
	...
	cy_mxs40_gpio_v1_0
		#(.id("b685180c-d7d4-4c92-be90-be1daf3a9a70"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("0"),
    ...
    cy_annotation_universal_v1_0 Green_1 (
        .connect({
            Net_424,
            Net_423
        })
    );
    defparam Green_1.comp_name = "LED_v1_0";
    defparam Green_1.port_names = "A, K";
    defparam Green_1.width = 2;

    cy_annotation_universal_v1_0 Resistor_Red_2 (
        .connect({
            Net_425,
            Net_424
        })
    );
    defparam Resistor_Red_2.comp_name = "Resistor_v1_0";
    defparam Resistor_Red_2.port_names = "T1, T2";
    defparam Resistor_Red_2.width = 2;
    ...
    Scan_ADC_v2_10_3 ADC_1 (
        ...
        .t_fvout(Net_534),
        .t_fvalid(Net_535),
        .t_fvinternal(Net_536[1:0]),
        .vagnd(Net_537),
        .vinPlus_0(Net_509));

	wire [0:0] tmpFB_0__value_net;
	wire [0:0] tmpIO_0__value_net;
	electrical [0:0] tmpSIOVREF__value_net;
	...
	cy_mxs40_gpio_v1_0
		...
		value
		 (.oe({1'b1}),
		  .y({1'b0}),
		  .fb({tmpFB_0__value_net[0:0]}),
		  .analog({Net_509}),
		  .io({tmpIO_0__value_net[0:0]}),
		  .siovref(tmpSIOVREF__value_net));


    SCB_I2C_PDL_v2_0_4 I2C (
        .clock(1'b0),
        .scl_b(Net_543),
        .sda_b(Net_544),
        .scl_trig(Net_545));
	...
	cy_mxs40_gpio_v1_0
		#(.id("4ba9ce1d-b70a-4b69-9b02-a0c7eec33bed"),
		  .width(1),
		  .sio_grp_cnt(0),
		  .drive_mode("2"),
		  .ibuf_enabled("1"),
